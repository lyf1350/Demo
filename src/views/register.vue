      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="input-group form-group">
              ...
              <input type="phone" class="form-control" placeholder="请输入电话" name="phone" v-model="phone">
            </div>
            <div class="input-group form-group">
              <div class="input-group-prepend">
                <span class="input-group-text">
              ...
              <input type="email" class="form-control" placeholder="请输入邮箱" name="email" v-model="email">
            </div>
...
@font-face {
  ...
  src: local("Numans"), local("Numans-Regular"),
    url(../assets/fonts/SlGRmQmGupYAfH84ZhIh.woff2)
      format("woff2");
